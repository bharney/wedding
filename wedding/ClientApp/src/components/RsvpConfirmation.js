    ...
    renderLoading() {
        if (this.state.isLoading) {
            return (<button id="rsvp" type="submit" onClick={(event) => this.SubmitForm(event)} value="getResponse" className="btn btn-primary btn-block btn-lg">
                Sending <i className="fa fa-spinner fa-spin" aria-hidden="true"/>
            </button>)
        }
        return (<button id="rsvp" type="submit" onClick={(event) => this.SubmitForm(event)} value="getResponse" className="btn btn-primary btn-block btn-lg">
            Send <i className="glyphicon glyphicon-send" aria-hidden="true" />
        </button>)
    }
        ...
        return (<div className="container pad-header text-center">
            <div className="row">
                <div className="col-12">
                    <h1><strong>Thank you! Your RSVP has been Confirmed.</strong></h1>
                    <h2>You should recive an email confirmation of your RSVP based on the information you entered.</h2>
                        ...
                        <div className="col-12 col-md-5">
                            ...
                            <ul className="list-group text-left">
                                <li className="list-group-item">
                                    <h4><i className="fa fa-phone fa-lg"/> Phone: (708) 310-5765</h4>
                                </li>
                                <li className="list-group-item">
                                    <h4><i className="fa fa-envelope-o fa-lg"/> Email: <a href="mailto:eahall515@gmail.com">eahall515@gmail.com</a></h4>
                                </li>
                            </ul>
                        </div>
